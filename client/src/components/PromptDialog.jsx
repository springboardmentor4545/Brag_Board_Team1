...
export function PromptDialog({ open, title, message, placeholder, confirmText = 'OK', cancelText = 'Cancel', onConfirm, onCancel, submitting }) {
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="pt-1 flex items-center justify-end gap-2">
            ...
            <button
              ...
              className="px-4 py-2 rounded-md bg-indigo-600 text-white hover:bg-indigo-700 disabled:opacity-60 text-sm"
            >
